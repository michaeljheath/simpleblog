...
$config['blog-entry'] = 'home/blogEntry';
$config['blog-entry-comments'] = 'home/blogEntryComments';
$config['admin-blog-entry'] = 'admin/blogEntry';
$config['admin-save-blog-entry'] = 'admin/saveBlogEntry';
